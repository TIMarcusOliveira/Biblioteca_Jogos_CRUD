...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30/09/2025 às 02:39
...
--
-- Banco de dados: `biblioteca_jogos`
--
CREATE DATABASE IF NOT EXISTS `biblioteca_jogos` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
--
ALTER TABLE `jogos`
  ADD CONSTRAINT `jogos_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`);
COMMIT;
